...
- Researching the application of large language models to software requirements engineering.
- Completed a Mitacs Globalink Research Internship at Toronto Metropolitan University, developing deep learning methods for motion estimation and ROI localization in cine-MRI.
- Previously worked as a Software Engineer at RAG MX, building web platforms, APIs, database workflows, and Python automation.
- First author of a research paper on fine-tuning Mistral 7B with QLoRA for automatic software-requirements generation. (still waiting for the doi...)
...
<a href="https://orcid.org" target="_blank">
  <img src="https://iconify.design" alt="ORCID" height="42" style="vertical-align: middle; background-color: #1a1a1a; padding: 4px; border-radius: 12px; margin: 0 4px;" />
</a>
